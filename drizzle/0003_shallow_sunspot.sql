...
ALTER TABLE "guest" ADD COLUMN "confirmation_code" text;--> statement-breakpoint
...
ALTER TABLE "guest" ALTER COLUMN "confirmation_code" SET NOT NULL;--> statement-breakpoint
