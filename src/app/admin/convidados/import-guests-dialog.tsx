...
export function ImportGuestsDialog({ open, onOpenChange }: ImportGuestsDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[700px] h-[600px] max-w-none border-black shadow-sm overflow-hidden flex flex-col">
        <DialogHeader>
        ...
        <div className="flex-1 flex flex-col space-y-4 overflow-hidden">
          ...
          <div className="flex-shrink-0">
            ...
            <Textarea
              ...
              className="h-[200px] resize-none border-black focus:border-gray-900 focus:ring-gray-900/20 shadow-sm"
          ...
          {/* Preview Section */}
          {showPreview && (
            <div className="flex-1 flex flex-col border border-black rounded-lg bg-gray-50/50 overflow-hidden">
